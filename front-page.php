		...
		<div class="col2">
			...
			<div class="col3">
				<div class="mod col4">
					...
					?>
						<div class="news">
							<a href="<?php bloginfo('url'); ?>/author/<?php the_author_meta('user_login'); ?>/" title="<?php the_author(); ?>"><?php echo get_avatar(get_the_author_meta('ID'), 35 ); ?></a>
							<h1><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
							<small>Posted by <a href="<?php bloginfo('url'); ?>/author/<?php the_author_meta('user_login'); ?>" title="<?php the_author(); ?>/"><?php the_author(); ?></a> on <?php the_time('j F Y') ?></small>
							<div class="entry">
