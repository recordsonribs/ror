...
<?php if ( $comment->comment_author_email == get_the_author_email() ) {
	...
	<div class="mod comments <?php echo $commentDivClass; ?>">
		<div <?php comment_class(); ?>>
			<div id="comment-<?php comment_ID(); ?>">
				<div class="mod-meta comment-author">
					<a class="comment-number" href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php echo gtcn_comment_numbering($comment->comment_ID,''); ?></a>
					<a class="comment-gravatar" href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php echo get_avatar($comment,$size='35'); ?></a>
					<div class="clear"></div>
				</div>
				...
				<div class="mod-body">
					<div class="entry">
						...
						<div class="comment-meta commentmetadata"><?php printf(__('<strong>%s</strong>'), get_comment_author_link()) ?><span class="date"><?php if(!function_exists('how_long_ago')){comment_date() . ' at ' . comment_time(); } else { echo how_long_ago(get_comment_time('U')); } ?></span><?php edit_comment_link(__('Edit'),'<span class="edit">','</span>') ?></div>
